...
export default function Home() {
  ...
  const howToWorkTexts = [
    {id: 1, title: "Tell us your theme", description: 'Want a "Historical Food Tour"? Just give our AI a theme. Our AI understands context and builds a logical plan.'},
    {id: 2, title: "Get your AI Plan", description: 'Instantly receive a full-day, multi-stop itinerary. We find the locations, calculate optimized routes (walking, bus, ect.), and show it all on one map.'},
    {id: 3, title: "Refine & Personalize", description: "Want to add a cool café? Type in its name, or upload a photo – our AI will find it and add it to your route instantly. You're in control"},
  ];
  const exploreTexts = [
    {id: 1, text: "View destinations with NAVER's 3D aerial map."},
    {id: 2, text: "Get AI-powered summaries of history and travel tips."},
    {id: 3, text: "See real-time public transit info for your route."},
  ]
    ...
    <div className='w-full min-h-screen'>
      ...
      <section id="how-it-works" className='w-full px-4 md:px-5 xl:px-8 2xl:px-[220px] pt-[108px] flex flex-col justify-center items-center gap-4'>
        ...
        <div className='w-full flex flex-col gap-12 lg:flex-row lg:gap-0 justify-around my-[102px]'>
          {howToWorkTexts.map(text => (
            <div key={text.id} className='w-full px-12 lg:w-[368px] flex flex-col justify-start items-center'>
        ...
        <div className='w-full lg:w-1/2 flex flex-col gap-4 pl-0 md:pl-5 xl:pl-8 2xl:pl-[220px]'>
          ...
          <div className='mt-4'>
            {exploreTexts.map(text => (
              <div key={text.id} className='mt-4 flex gap-2'>
